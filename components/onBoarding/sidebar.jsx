    ...
    >
      ...
      <SidebarHeader className="border-b border-gray-100/80 p-0 bg-white">
        <div className="flex items-center gap-3 px-6 py-4">
          ...
          <h1 className="text-lg  text-gray-900">Setup business profile</h1>
        </div>
      </SidebarHeader>

      {/* Form Content */}
      <SidebarContent className="px-6 py-6 overflow-y-auto bg-white rounded-2xl">
        <div className="space-y-6">
          ...
          <label htmlFor="multipleBranches" className="text-sm font-normal text-[#081F24]">Do you have multiple branches?</label>
          <div className="flex bg-white rounded-lg mt-1 border border-gray-200 overflow-hidden shadow-sm" id="multipleBranches">
            {/* Yes Option */}
            <button
              onClick={() => setSelected("yes")}
              className={`
    relative flex-1 p-4 flex items-center justify-center transition-colors
        ...
        <div className="px-6 py-4">
          <div className="flex gap-3 justify-between">
            <Button
              variant="outline"
              onClick={handleCancel}
              className="h-11 border-gray-200 text-[#081F24] hover:bg-gray-50 bg-transparent rounded-lg transition-all"
            >
              Cancel
            </Button>
            <Button
              onClick={handleSave}
              className="h-11 bg-gray-900 text-white hover:bg-gray-800 rounded-lg transition-all"
            >
              Save
            </Button>
          </div>
